...
urlpatterns = [
    ...
    path('royalogin', LoginView.as_view(template_name='vehicle/royalogin.html'),name='royalogin'),
    path('mechaniclogin', LoginView.as_view(template_name='vehicle/mechaniclogin.html'),name='mechaniclogin'),
    path('adminlogin', LoginView.as_view(template_name='vehicle/royalogin.html'),name='adminlogin'),



    path('admin-dashboard', views.admin_dashboard_view,name='admin-dashboard'),

    path('admin-cars', views.admin_cars,name='admin-cars'),
    path('admin-view-cars', views.admin_view_cars_view,name='admin-view-cars'),
    path('admin-add-cars', views.admin_add_cars_view,name='admin-add-cars'),
    path('delete-cars/<int:pk>', views.delete_cars_view,name='delete-cars'),
    path('update-cars/<int:pk>', views.update_cars_view,name='update-cars'),
